...
Convolutional neural networks are considered state-of-the-arts for text classification (\cite{CaoLLW17, kim2014convolutional, zhang2015understanding, XiaoC16}) and therefore, we naturally implement a similar model based on \cite{kim2014convolutional}. \note{To continue by describing the model}.
